...
{
    if ([[segue identifier] isEqualToString:@"showRepositories"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        NSManagedObject *object = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        [[segue destinationViewController] setUsername:[object valueForKey:@"name"]];
    }
...
- (void)insertNewUser:(NSString *)username {
    ...
    [newManagedObject setValue:username forKey:@"name"];
